...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($uploadOk == 0) {
        ...
        if (move_uploaded_file($_FILES["customFile"]["tmp_name"], $targetFile)) {
            ...
            $sql = "INSERT INTO category (category_name, category_description, img)
            VALUES ('$categoryName', '$description', '$targetFile')";
                ...
                <div class="form-container">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="discription" id="discription" cols="30" rows="10" required></textarea>
